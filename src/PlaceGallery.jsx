...
export default function PlaceGallery({place}){ //for displaying the photos of the place either a few or all depending on choice
        ...
        return(
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                ...
                <div>
                    ...
                    <button onClick={()=>setShowAllPhotos(false)} className="fixed right-12 bg-white text-black top-8 flex gap-1 py-2 px-4 rounded-2xl shadow shadow-black">
